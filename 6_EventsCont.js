...
contract.getPastEvents("AllEvents",{fromBlock: 0, toBlock: "latest"},(error,evetns)=>{
...
// we can get events from specific block numbers as well  as follow:

contract.getPastEvents("AllEvents",{fromBlock: 11132792, toBlock: "latest"},(error,evetns)=>{
